...
public interface LocalSlBookMapper {
     ...
     * @return
     */
    @Select("SELECT * FROM sl_book WHERE sl_data_type_id = #{dataTypeId} AND sl_is_free != 3 ORDER BY sl_like_size DESC " +
            "LIMIT 0 , 10")
    List<SlBook> getBookInfoByTypeAndLike(Integer dataTypeId);
}
